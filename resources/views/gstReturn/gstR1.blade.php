                ...
                <div class="container-fluid">
                    <ul class="nav nav-fill nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="fill-tab-0" data-bs-toggle="tab" href="#fill-tabpanel-0" role="tab" aria-controls="fill-tabpanel-0" aria-selected="true"> GSTR-1 (view)</a>
                        </li>
                        <li class="nav-item" role="presentation">
...
<script>
    ...
    function toggleDetails(index) {
        ...
        const clickedRow = document.querySelector(`tr[onclick="toggleDetails(${index})"]`);
    ...
    function togglePartySummary() {
        const summaryBody = document.getElementById('party-summary');
        const checkbox = document.getElementById('detailedCheckbox');
        ...
        if (checkbox.checked) {
            ...
            // Close any open detail row as well
            if (currentlyOpenRow) {
                currentlyOpenRow.style.display = 'none';
    ...
    const newRow = document.getElementById('details-' + index);
    const clickedRow = document.querySelector(`tr[onclick="toggleCreditNoteDetails('${index}')"]`);
 ...
 function toggleCreditNoteSummary() {
        const summaryBody = document.getElementById('credit-note-summary');
        const checkbox = document.getElementById('creditNoteDetailedCheckbox');
