                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-3">
                                            ...
                                            <option value="0.25" data-type="taxable" @if($item_gst_rate->gst_rate == "0.25") selected @endif>0.25% (Precious stones, etc.)</option>
                                            <option value="3" data-type="taxable" @if($item_gst_rate->gst_rate == "3") selected @endif>3% (Gold, jewelry)</option>
                                            <option value="5" data-type="taxable" @if($item_gst_rate->gst_rate == "5") selected @endif>5%</option>
                                            <option value="12" data-type="taxable" @if($item_gst_rate->gst_rate == "12") selected @endif>12%</option>
                                            <option value="18" data-type="taxable" @if($item_gst_rate->gst_rate == "18") selected @endif>18%</option>
                                            <option value="28" data-type="taxable" @if($item_gst_rate->gst_rate == "28") selected @endif>28%</option>
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <input 
                                        ...
                                        required
                                        value="{{ old('with_effect_from', \Carbon\Carbon::parse($item_gst_rate->effective_from)->format('Y-m-d')) }}"
                                    />
                                </div>
