...
<div class="col-md-12 ml-sm-auto col-lg-10 px-md-4 bg-mint">
    ...
    <div class="bg-white shadow-sm p-4">
        ...
        <form method="POST"
              action="{{ route('gst-return-compliance.update',$compliance->id) }}">
            ...
            <div class="row">
                    ...
                    <select name="gst_number"
                        ...
                        @foreach($gst as $row)
                            ...
                            <option value="{{ $row->gst_no }}"
                                {{ old('gst_number',$compliance->gst_number) == $row->gst_no ? 'selected' : '' }}>
                                {{ $row->gst_no }}
                            </option>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="month"
                        ...
                        min="{{ $fy_start_month }}"
                        max="{{ $fy_end_month }}"
                        value="{{ old('month_year',$compliance->month_year) }}"
                        required>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select name="return_type"
                        ...
                        <option value="GSTR-1"
                            {{ old('return_type',$compliance->return_type) == 'GSTR-1' ? 'selected' : '' }}>
                            GSTR-1
                        </option>

                        <option value="GSTR-3B"
                            {{ old('return_type',$compliance->return_type) == 'GSTR-3B' ? 'selected' : '' }}>
                            GSTR-3B
                        </option>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="text"
                        ...
                        maxlength="15"
                        class="form-control"
                        value="{{ old('arn_number',$compliance->arn_number) }}"
                        required>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select name="is_locked"
                        ...
                        <option value="1"
                            {{ old('is_locked',$compliance->is_locked) == 1 ? 'selected' : '' }}>
                            Enable Lock
                        </option>

                        <option value="0"
                            {{ old('is_locked',$compliance->is_locked) == 0 ? 'selected' : '' }}>
                            Disable Lock
                        </option>
