      ...
      <div class="row vh-100">
         ...
         <div class="col-md-12 ml-sm-auto  col-lg-9 px-md-4 bg-mint">
            ...
            <div class="table-title-bottom-line position-relative d-flex justify-content-between align-items-center bg-plum-viloet title-border-redius border-divider shadow-sm py-2 px-4">
               <h5 class="transaction-table-title m-0 py-2">List of Add Return Sale Voucher</h5>
               ...
               <div class="d-md-flex d-block"> 
                  <a href="{{ route('credit-note-without-item.create') }}" class="btn btn-xs-primary">ADD WITHOUT ITEM<svg class="position-relative ms-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <tbody>
                     ...
                     foreach ($sale as $value) { ?>
                        <tr class="font-14 font-heading bg-white">
                           ...
                           <td class="w-min-120 " style="text-align: center;"><?php echo $value->series_no."/".$value->financial_year."/CR".$value->sale_return_no; ?></td>
