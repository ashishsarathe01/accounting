               ...
               <div class="row">
                  ...
                  <div class="mb-3 col-md-3 parameter_sec" style="display:none;">
                     ...
                     <select class="form-select" name="no_of_parameter" id="no_of_parameter">
                        ...
                        <option value="4" @if($itemsgroup && $itemsgroup->no_of_parameter==4) selected  @endif>4</option>
                        <option value="5" @if($itemsgroup && $itemsgroup->no_of_parameter==5) selected  @endif>5</option>
                     </select>
                  </div>
                  <div class="clearfix"></div> 
                  
                  <div class="mb-2 col-md-2 parameter_sec" style="display:none">
                     <input type="checkbox" name="alternative_qty" id="alternative_qty" value="1" @if($itemsgroup->alternative_qty==1) checked @endif onclick="showAlternativeDiv();"> Alternative Qty
                  </div>
                  <br><br>
                  <div class="clearfix"></div>
   ...
   function callParameterInput(){
      ...
      if($("#no_of_parameter").val()!=""){
         ...
         while(no_of_parameter>=i){
            ...
            let conversion_yes = "";let conversion_no = "checked";let alternative_unit = "";
            if(para.length>0){
               if(para[j]){
                  ...
                  if(para[j]['conversion_factor']=="1"){
                     conversion_yes = "checked";
                     conversion_no = "";
                  }
                  if(para[j]['alternative_unit']=="1"){
                     alternative_unit = "checked";
                  }
               }
            }
