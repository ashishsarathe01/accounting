                     ...
                     <tbody>
                        ...
                        foreach ($purchase as $value) { ?>
                           <tr class="font-14 font-heading bg-white">
                              ...
                              <td style="text-align: right;"><?php echo $value->voucher_no ?></td>
                              ...
                              <td class="w-min-120  text-center">
                                 ...
                                 if(in_array(date('Y-m',strtotime($value->date)),$month_arr)){?>
                                    <a href="{{ URL::to('purchase-edit/'.$value->purchases_id) }}">  <img src="{{ URL::asset('public/assets/imgs/edit-icon.svg')}}" class="px-1" alt="">
                                    </a>
                                 ...
                                 <a title="View Invoice" href="{{ URL::to('purchase-invoice/' . $value->purchases_id) }}" target="__blank"><img src="{{ URL::asset('public/assets/imgs/eye-icon.svg')}}" class="px-1" alt=""></a>
                              </td>
                           </tr>
                           <?php 
                        } ?>
