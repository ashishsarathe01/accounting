                  ...
                  @foreach ($gstConfigData as $index=>$value)
                     ...
                     <div class="bg-white px-4 py-4 border-divider border-radius-8 shadow-sm multipal-show" @if($ind%2==0) style="background-color:#E8E8E8 !important" @endif>
                        <div class="row">                        
                           ...
                           <div class="mb-4 col-md-4">
                              <label for="name" class="form-label font-14 font-heading">Authorized Signatory 1</label>
                              <input type="text" class="form-control" name="authorized_signatory_1[{{$index}}][]" placeholder="Authorized Signatory 1" value="{{$value->authorized_signatory_1 }}">
                           </div>
                           <div class="mb-4 col-md-4">
                              <label for="name" class="form-label font-14 font-heading">Authorized Signatory Pan No. 1</label>
                              <input type="text" class="form-control" name="authorized_signatory_pan_no_1[{{$index}}][]" placeholder="Authorized Signatory Pan No. 1" value="{{$value->authorized_signatory_pan_no_1 }}">
                           </div>
                           <div class="clearfix"></div>
                           <div class="mb-4 col-md-4">
                              <label for="name" class="form-label font-14 font-heading">Authorized Signatory 2</label>
                              <input type="text" class="form-control" name="authorized_signatory_2[{{$index}}][]" placeholder="Authorized Signatory 2" value="{{$value->authorized_signatory_2 }}">
                           </div>
                           <div class="mb-4 col-md-4">
                              <label for="name" class="form-label font-14 font-heading">Authorized Signatory Pan No. 2</label>
                              <input type="text" class="form-control" name="authorized_signatory_pan_no_2[{{$index}}][]" placeholder="Authorized Signatory Pan No. 2" value="{{$value->authorized_signatory_pan_no_2 }}">
                           </div>
                        </div>
                        ...
                        <div class="row e-invoice-yes">
                           ...
                           @php
                           $decrypted = '';
                           if(!empty($value->einvoice_password)){
                              try {
                                 $decrypted = decrypt($value->einvoice_password);
                              } catch (\Exception $e) {
                                 $decrypted = '';
                              }
                           }
                           ...
                           <div class="mb-4 col-md-4">
                              ...
                              <input type="password" class="form-control"  id="einvoice_password" name="einvoice_password[{{$index}}][]" placeholder="Enter password" value="{{$decrypted}}"/>
                           </div>
                        </div>
                        <!-- E--- Way Bill -->
                        ...
                        <div class="row e-waybill-yes">
                           ...
                           @php
                           $decrypted = '';
                           if(!empty($value->ewaybill_password)){
                              try {
                                 $decrypted = decrypt($value->ewaybill_password);
                              } catch (\Exception $e) {
                                 $decrypted = '';
                              }
                           }
                           ...
                           <div class="mb-4 col-md-4">
                              <label for="ewaybill_password_{{$index}}" class="form-label font-14 font-heading">Password</label>
                              <input type="password" class="form-control"  id="ewaybill_password_{{$index}}" name="ewaybill_password[{{$index}}][]" placeholder="Enter password"  value="{{$decrypted}}" />
                           </div>
                        </div>
                        <!-- addbranch toggle -->
