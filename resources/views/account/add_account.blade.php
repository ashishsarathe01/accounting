                  ...
                  <div class="mb-4 col-md-4">
                     ...
                     <select class="form-select form-select-lg select2-single" name="under_group" id="under_group" aria-label="form-select-lg example" required>
                        ...
                        @foreach($accountgroup as $value)
                           @php $under_debtor_status = 0;$under_creditors_status = 0; @endphp
                           ...
                           @endif
                           <option value="{{$value->id}}" data-type="group" data-under_debtor_status="{{$under_debtor_status}}" data-under_creditors_status="{{$under_creditors_status}}" @if(isset($id) && $account->under_group==$value->id && $account->under_group_type=='group') selected  @endif>{{$value->name}}</option>
                        @endforeach
                        @foreach($accountheading as $value)
                           <option value="{{$value->id}}" data-type="head" data-under_debtor_status="0" data-under_creditors_status="0" @if(isset($id) && $account->under_group==$value->id && $account->under_group_type=='head') selected  @endif>{{$value->name}}</option>
                        @endforeach                      
                     </select>
...
<script>
   ...
   $("#under_group").change(function(){
      ...
      if($(this).val()==1 && $('option:selected', this).attr('data-type')=='group'){
         ...
         $(".bank_name_div").show();
      }else if($(this).val()==18 && $('option:selected', this).attr('data-type')=='group'){
         $(".account_no_div").show();
         $(".ifsc_code_div").show();
         $(".mobile_no_div").show();
         $(".email_div").show();
      }else if(($(this).val()==5 || $(this).val()==6) && $('option:selected', this).attr('data-type')=='group'){
         $(".account_no_div").show();
         $(".ifsc_code_div").show();
         $(".mobile_no_div").show();
         $(".email_div").show();
