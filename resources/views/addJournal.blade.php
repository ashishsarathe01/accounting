    ...
    <section class="list-of-view-company-section container-fluid">
        <div class="row vh-100">
            ...
            <div class="col-md-12 ml-sm-auto  col-lg-8 px-md-4 bg-mint">
                ...
                <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('journal.store') }}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="custom-radio me-4 d-flex">
                                <input type="radio" class="custom-radio-input journal-hide" name="flexRadioDefault" id="flexRadioDefault1">
                                <label for="flexRadioDefault1" class="custom-radio-label me-4 ps-4 ">Yes</label>
                                <input type="radio" class="custom-radio-input journal-show" name="flexRadioDefault" id="flexRadioDefault2">
