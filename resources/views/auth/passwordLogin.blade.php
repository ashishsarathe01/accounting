    ...
    <div class="d-flex align-items-center">
        <div class="mx-auto card login-card p-4">
            ...
            <div class="text-center mb-4">
                <h1>Login</h1>
                <p class="font-14">
                    To access your account, Enter your registered email ID and password
                </p>
            </div>
            ...
            @endif
            <form method="POST" action="{{ route('password.login-check') }}">
                @csrf
                <div class="mb-4">
                ...
                <button type="submit" class="btn btn-primary w-100 mb-4">LOGIN WITH PASSWORD</button>
            </form>
            <div class="text-center mb-4">
