   ...
   <section class="list-of-view-company-section container-fluid">
      <div class="row vh-100">
         ...
         <div class="col-md-12 ml-sm-auto  col-lg-9 px-md-4 bg-mint">
            ...
            <h5 class="table-title-bottom-line px-4 py-3 m-0 bg-plum-viloet position-relative title-border-redius border-divider shadow-sm">Import Payment</h5>
...
<script type="text/javascript">
   ...
   $('form#upload_form').on('submit', function(e){
      ...
      $("#cover-spin").show();
      $.ajax({
         url: '{{ URL::route("payment-import-process") }}',
         type: 'POST',
         data: formData,
         async: true,
         cache: false,
