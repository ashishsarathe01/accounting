            ...
            <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('sale.update') }}" id="saleForm">
               ...
               <div class="row">
                     ...
                     <select id="series_no" name="series_no" class="form-select" required>
                        ...
                        if(count($mat_series) > 0) {
                           foreach ($mat_series as $value) { ?>
                              <option value="<?php echo $value['branch_series']; ?>" <?php if($value['branch_series']==$sale->series_no){ echo "selected";} ?>><?php echo $value['branch_series']; ?></option>
                              <?php 
                           }
                        } ?>
                     </select>
                  ...
                  <div class="mb-4 col-md-4">
                     ...
                     <input type="number" class="form-control" name="voucher_no" placeholder="376481" value="{{$sale->voucher_no}}"/>
                     <ul style="color: red;">
                  ...
                  <div class="mb-4 col-md-5">
                     ...
                     <select class="form-select select2-single" id="party" name="party" required>
                        ...
                        foreach ($party_list as $value) { ?>
                           <option value="<?php echo $value->id; ?>" data-gstin="<?php echo $value->gstin; ?>" data-address="<?php echo $value->address.",".$value->pin_code; ?>" <?php if($value->id==$sale->party){ echo "selected";}?>><?php echo $value->account_name; ?></option>
                           <?php 
                        } ?>
                     </select>
                     ...
                     <select name="material_center" class="form-select" required>
                        ...
                        if(count($mat_center) > 0) {
                           foreach ($mat_center as $value) { ?>
                              <option value="<?php echo $value['branch_matcenter']; ?>" <?php if($value['branch_matcenter']==$sale->material_center){ echo "selected";}?>><?php echo $value['branch_matcenter']; ?></option>
                              <?php 
                           }
                        } ?>
                     </select>
                     ...
                     <tbody>
                        ...
                        @foreach($SaleDescription as $item)
                           <tr id="tr_{{$i}}" class="font-14 font-heading bg-white">
                              ...
                              <td class="w-min-50">
                                 <input type="text" class="quantity w-100 form-control" id="quantity_tr_{{$i}}" name="qty[]" value="{{$item->qty}}" placeholder="Quantity" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="text-align:right;" >
                              </td>
                              <td class="w-min-50">
                              ...
                              <td class="w-min-50">
                                 <input type="text" class="price form-control" id="price_tr_{{$i}}" name="price[]" value="{{$item->price}}" placeholder="Price" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="text-align:right;">
                              </td>
                              <td class="">
                                 <input type="text" id="amount_tr_{{$i}}" class="amount w-100 form-control" name="amount[]" value="{{$item->amount}}" placeholder="Amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="text-align:right;">
                              </td>
                              <td class=""><svg style="color: red;cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-minus-fill remove" data-id="{{$i}}" viewBox="0 0 16 16"><path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M6 7.5h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1 0-1"/></svg></td>
                           </tr>
                                 ...
                                 <tr class="font-14 font-heading bg-white">
                                    ...
                                    <td colspan="3">
                                       <select class="w-95-parsent form-select" id="self_vehicle" name="self_vehicle">
                                          <option value="">Select</option>
                                          <option value="Yes" <?php if($sale->self_vehicle=="Yes"){ echo "selected";}?>>Yes</option>
                                          <option value="No" <?php if($sale->self_vehicle=="No"){ echo "selected";}?>>No</option>
                                       </select>
                                    </td>
                                 </tr>
                                 <tr class="font-14 font-heading bg-white">
                                    ...
                                    <td colspan="3" class="">
                                       <input type="text" name="vehicle_no" value="{{$sale->vehicle_no}}" placeholder="Vehicle No." class="form-control">
                                    </td>
                                 </tr>
                              </div>
                              <div class="other-details">
                                 ...
                                 <div class="other-details-show-details">
                                    <tr class="font-14 font-heading bg-white other-details-show other-details-show">
                                       ...
                                       <td colspan="3" class="">
                                          <input type="text" name="transport_name" value="{{$sale->transport_name}}" placeholder="Transport Name" class="form-control">
                                       </td>
                                    </tr>
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                       ...
                                       <td colspan="3">
                                          <select class="w-95-parsent form-select" id="reverse_charge" name="reverse_charge">
                                             <option value="">Select</option>
                                             <option value="Yes" <?php if($sale->reverse_charge=="No"){ echo "selected";}?>>Yes</option>
                                    ...
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                       ...
                                       <td colspan="3" class="">
                                          <input type="text" name="gr_pr_no" value="{{$sale->gr_pr_no}}" class="form-control" placeholder="GR/RR No.">
                                       </td>
                                    </tr>
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                       <td colspan="2" class="pl-40">Station</td>
                                       <td colspan="3" class="">
                                          <input type="text" name="station" value="{{$sale->station}}" placeholder="Station" class="form-control">
                                       </td>
                                    </tr>
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                    ...
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                       ...
                                       <td colspan="3" class="">
                                          <input type="text" name="shipping_address" value="{{$sale->shipping_address}}" class="form-control" placeholder="Shipping Address">
                                       </td>
                                    </tr>
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                       <td colspan="2" class="pl-40">Shipping Pincode</td>
                                       <td colspan="3" class="">
                                          <input type="text" name="shipping_pincode" value="{{$sale->shipping_pincode}}" placeholder="Shipping Pincode" class="form-control">
                                       </td>
                                    </tr>
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                       <td colspan="2" class="pl-40">Shipping GST</td>
                                       <td colspan="3" class="">
                                          <input type="text" name="shipping_gst" value="{{$sale->shipping_gst}}" class="form-control" placeholder="Shipping GST">
                                       </td>
                                    </tr>
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                       <td colspan="2" class="pl-40">Shipping PAN</td>
                                       <td colspan="3" class="">
                                          <input type="text" name="shipping_pan" value="{{$sale->shipping_pan}}" class="form-control" placeholder="Shipping PAN">
                                          <input type="hidden" name="shipping_state" value="{{$sale->shipping_state}}" >
                                       </td>
                                    </tr>
                                    <tr class="font-14 font-heading bg-white other-details-show">
                                       <td colspan="2" class="pl-40">E-Way Bill No</td>
                                       <td colspan="3" class=""><input type="text" name="ewaybill_no" value="{{$sale->ewaybill_no}}" class="form-control" placeholder="E-Way Bill No">
                                       </td>
                                    </tr>
                                 </div>
                              </div>
...
<script>
   ...
   $(".add_more").click(function(){
      ...
      newRow += '</select></td><td class="w-min-50"><input type="text" class="quantity w-100 form-control" name="qty[]" id="quantity_tr_' + add_more_count + '"/ style="text-align:right"></td><td class=" w-min-50"><input type="text" class="w-100 form-control" id="unit_tr_'+add_more_count+'" readonly style="text-align:center;"/><input type="hidden" class="units w-100" name="units[]" id="units_tr_' + add_more_count + '"/></td><td class=" w-min-50"><input type="text" class="price w-100 form-control" name="price[]" id="price_tr_' + add_more_count + '" style="text-align:right"/></td><td class=" w-min-50"><input type="text" class="amount w-100 form-control" name="amount[]" id="amount_tr_' + add_more_count + '"  style="text-align:right"/></td><td class="w-min-50"><svg style="color: red;cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-minus-fill remove" data-id="' + add_more_count + '" viewBox="0 0 16 16"><path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M6 7.5h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1 0-1"/></svg></td></tr>';
