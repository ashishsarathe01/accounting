    ...
    <section class="list-of-view-company-section container-fluid">
        <div class="row vh-100">
            ...
            <div class="col-md-12 ml-sm-auto  col-lg-10 px-md-4 bg-mint">
                ...
                <form class="bg-white px-4 py-3" method="POST" action="{{ route('submit-edit-bank.update') }}">
                    @csrf
                    <input type="hidden" name="bank_id" id="bank_id" value="{{$bank_data->id}}">
                    <div class="row">
                        <div class="mb-4 col-md-4">
                            <label for="account_name" class="form-label font-14 font-heading">Name</label>
                            <input type="text" class="form-control" id="account_name" name="account_name" value="{{$bank_data->name}}" placeholder="Enter Name " required />
                        </div>
                        <div class="mb-4 col-md-4">
                            <label for="name" class="form-label font-14 font-heading">A/C no.</label>
                            <input type="text" class="form-control" id="account_no" value="{{$bank_data->account_no}}" name="account_no" placeholder="Enter A/C no." required />
                        </div>
                        <div class="mb-4 col-md-4">
                            <label for="name" class="form-label font-14 font-heading">IFSC Code</label>
                            <input type="text" class="form-control" id="ifsc" name="ifsc" value="{{$bank_data->ifsc}}" placeholder="Enter IFSC code " required />
                        </div>
                        <div class="mb-4 col-md-4">
                            <label for="name" class="form-label font-14 font-heading">Bank Name</label>
                            <input type="text" class="form-control" id="bank_name" value="{{$bank_data->bank_name}}" name="bank_name" placeholder="Enter bank name " required />
                        </div>
                        <div class="mb-4 col-md-4">
                            <label for="name" class="form-label font-14 font-heading">Branch</label>
                            <input type="text" class="form-control" id="branch" value="{{$bank_data->branch}}" name="branch" placeholder="Enter branch name" required />
                        </div>
                    </div>
