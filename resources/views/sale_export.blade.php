   ...
   <section class="list-of-view-company-section container-fluid py-3">
        <div class="row">
         ...
         <div class="col-md-12 col-lg-9 px-md-4 bg-light">
            ...
            @endif
            <h5 class="table-title-bottom-line px-4 py-3 m-0 bg-plum-viloet position-relative title-border-redius border-divider shadow-sm">Export Sales Challan</h5>
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <form method="POST" action="{{ route('sale-export') }}" class="row g-4">
                        @csrf
                        <div class="col-md-4">
