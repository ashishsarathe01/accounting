               ...
               <div class="row">
                     ...
                     <select id="series_no" name="series_no" class="form-select" required>
                        ...
                        if(count($mat_series) > 0) {
                           foreach ($mat_series as $value) { ?>
                              <option value="<?php echo $value->series; ?>" data-mat_center="<?php echo $value->mat_center;?>" data-gst_no="<?php echo $value->gst_no;?>" data-invoice_start_from="<?php echo $value->invoice_start_from;?>"><?php echo $value->series; ?></option>
                              <?php 
                           }
                        } ?>
                     </select>
                  ...
                  <div class="mb-4 col-md-4">
                     ...
                     <span style="display: inline-flex">
                        ...
                        <input type="text" id="purchase_return_no" class="form-control" name="purchase_return_no" value="{{$purchase_return_no}}" required readonly style="width: 30%;">
...
<script>
   ...
   $('#voucher_no').change(function() {
      ...
      $.ajax({
         url: '{{url("get-next-purchasereturnno")}}',
         async: false,
         type: 'POST',
         dataType: 'JSON',
         data: {
