               ...
               <nav aria-label="breadcrumb meri-breadcrumb ">
                  <ol class="breadcrumb meri-breadcrumb m-0  ">
                     ...
                     <li class="breadcrumb-item p-0">
                        <a class="fw-bold font-heading font-12  text-decoration-none" href="#">Edit Return Sale</a>
                     </li>
                  </ol>
               </nav>
            </div>
            ...
            <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('sale-return-update') }}" id="saleReturnForm">
               ...
               <div class="row">
                  ...
                  <div class="mb-4 col-md-4">
                     ...
                     <select class="form-select select2-single" id="party" name="party" required>
                        ...
                        foreach ($party_list as $value) { ?>
                           <option value="<?php echo $value->id; ?>" data-gstin="<?php echo $value->gstin; ?>" data-address="<?php echo $value->address.",".$value->pin_code; ?>" <?php if($sale_return->party==$value->id){ echo "selected";} ?>><?php echo $value->account_name; ?></option>
                           <?php 
                        } ?>
                     </select>
                     ...
                     <select id="series_no" name="series_no" class="form-select" required>
                        ...
                        if(count($mat_series) > 0) {
                           foreach ($mat_series as $value) { ?>
                              <option value="<?php echo $value['branch_series']; ?>" <?php if($sale_return->series_no==$value['branch_series']){ echo "selected";} ?>><?php echo $value['branch_series']; ?></option>
                              <?php 
                           }
                        } ?>
                     </select>
                     ...
                     <select name="material_center" class="form-select" required>
                        ...
                        if(count($mat_center) > 0) {
                           foreach ($mat_center as $value) { ?>
                              <option value="<?php echo $value['branch_matcenter']; ?>" <?php if($sale_return->material_center==$value['branch_matcenter']){ echo "selected";} ?>><?php echo $value['branch_matcenter']; ?></option>
                              <?php 
                           }
                        } ?>
                     </select>
                  ...
                  <div class="mb-4 col-md-4">
                     ...
                     <input type="text" id="sale_return_no" class="form-control" name="sale_return_no" required readonly value="{{$sale_return->sale_return_no}}">
                  </div>
               </div>
                  ...
                  <table id="example11" class="table-striped table m-0 shadow-sm table-bordered">
                     <thead>
                        <tr class=" font-12 text-body bg-light-pink ">
                           ...
                           <th class="w-min-50 border-none bg-light-pink text-body " style="width: 25%;">Description of Goods
                           </th>                           
                     ...
                     <tbody>
                        ...
                        @foreach($sale_return_description as $item)
                           ...
                           <tr id="tr_@php $i; @endphp" class="font-14 font-heading bg-white">
                              ...
                              <td class=" w-min-50">
                                 <input type="text" class="price form-control" id="price_tr_@php echo $i; @endphp" name="price[]" value="{{$item->price}}" style="text-align:right;"/>
                              </td>
                              <td class=" w-min-50">
                                          ...
                                          <select id="bill_sundry_@php echo $index;@endphp" class="w-95-parsent  bill_sundry_tax_type form-select" name="bill_sundry[]" data-id="@php echo $index;@endphp">
                                             ...
                                             foreach ($billsundry as $value) { 
                                                if($value->effect_gst_calculation==1){?>
                                                   <option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-sundry_percent="<?php echo $value->sundry_percent;?>" data-sundry_percent_date="<?php echo $value->sundry_percent_date;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" data-sequence="<?php echo $value->sequence;?>" class="sundry_option_@php echo $index;@endphp" id="sundry_option_<?php echo $value->id;?>_1" <?php if($sundry->bill_sundry==$value->id){ echo "selected";} ?> data-nature_of_sundry="<?php echo $value->nature_of_sundry;?>"><?php echo $value->name; ?></option>
                                                   <?php 
                                                }
                                             } ?>
                                          </select>
                                             ...
                                             <select id="bill_sundry_@php echo $index;@endphp" class="w-95-parsent  bill_sundry_tax_type form-select" name="bill_sundry[]" data-id="@php echo $index;@endphp">
                                                ...
                                                foreach ($billsundry as $value) { 
                                                   if($value->id==$v1['bill_sundry']){?>
                                                      <option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" data-sequence="<?php echo $value->sequence;?>" class="sundry_option_@php echo $index;@endphp" id="sundry_option_@php echo $index;@endphp" data-nature_of_sundry="<?php echo $value->nature_of_sundry;?>"><?php echo $value->name; ?></option>
                                                      <?php 
                                                   }
                                                } ?>
                                             </select>
                           ...
                           <tbody>
                              <div>
                                 <tr class="font-14 font-heading bg-white">
                                    ...
                                    <td colspan="3" class="">
                                       <input type="text" name="vehicle_no" placeholder="Vehicle No." value="{{$sale_return->vehicle_no}}" class="form-control"/>
                                    </td>
                                 </tr>
                                 <tr class="font-14 font-heading bg-white">
