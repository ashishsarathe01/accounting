            ...
            <div class="col-md-12 ml-sm-auto  col-lg-10 px-md-4 bg-mint">
                ...
                <div class="d-xxl-flex justify-content-between py-4 px-2 align-items-center">
                    ...
                    <div class="d-xxl-flex d-block  align-items-center">
                        <p class="text-nowrap m-0 font-14 fw-500 font-heading my-2 my-xxl-0">Filter By </p>
                        <select class="form-select w-min-230 ms-xxl-2" aria-label="Default select example">
                    ...
                    <table id="example" class="table-striped table m-0 shadow-sm ">
                        ...
                        <tbody>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">01/04/2023 </td>
                                <td class="w-min-120 ">SupO</td>
                                <td class="w-min-120 ">1</td>
                                <td class="w-min-120 ">Mehak Packaging</td>
                                <td class="w-min-120 "></td>
                                <td class="w-min-120 ">3,391.92</td>
                                <td class="w-min-120 ">2,96,058.08</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">01/04/2023 </td>
                                <td class="w-min-120 ">SupO</td>
                                <td class="w-min-120 ">2</td>
                                <td class="w-min-120 ">Sakshi Packers</td>
                                <td class="w-min-120 "></td>
                                <td class="w-min-120 ">2,555.64</td>
                                <td class="w-min-120 ">2,93,502.44</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">01/04/2023 </td>
                                <td class="w-min-120 ">SupO</td>
                                <td class="w-min-120 ">3</td>
                                <td class="w-min-120 ">Ganga Packaging (India)</td>
                                <td class="w-min-120 "></td>
                                <td class="w-min-120 ">2,631.90</td>
                                <td class="w-min-120 ">2,96,058.08</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">01/04/2023 </td>
                                <td class="w-min-120 ">SupO</td>
                                <td class="w-min-120 ">4</td>
                                <td class="w-min-120 ">Dabas Packaging Co.</td>
                                <td class="w-min-120 "></td>
                                <td class="w-min-120 ">3,391.92</td>
                                <td class="w-min-120 ">2,96,058.08</td>
                            </tr>
                        ...
                        <div>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120" colspan="5"></td>
                                <td class="w-min-120 fw-bold">2,555.64</td>
                                <td class="w-min-120 fw-bold">2,93,502.44</td>
                            </tr>
                        </div>
                        <div>
                            <tr class="font-14 fw-bold font-heading">
                                <td class="text-end " colspan="7">
                                    Closing Bal.- 83,289.67
                                </td>
                            </tr>
                        </div>
                    </table>
