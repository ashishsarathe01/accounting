...
<div class="table-title-bottom-line d-flex justify-content-between align-items-center bg-plum-viloet shadow-sm py-2 px-4">
    <h5 class="transaction-table-title m-0 py-2">
        Part Life Chart – Add Entries
    </h5>

    <a href="{{ route('part-life.entries') }}" class="btn btn-border-body">
        BACK
    </a>
</div>

    <form method="POST" action="{{ route('part-life.entries.store') }}">
    @csrf
        ...
        <div class="card shadow-sm mt-4 p-4">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="items[0][unit]" class="form-control unit-field" readonly placeholder="Unit" style="height: 25px;">
            ...
            <div class="col-md-2">
                ...
                <input type="number" 
                    ...
                    min="0"
                    step="0.01"
                    oninput="validateDecimal(this)" placeholder="Quantity">
            </div>
            ...
            <div class="col-md-3">
                ...
                <input type="number" 
                    ...
                    min="0"
                    step="0.01"
                    oninput="validateDecimal(this)" placeholder="Rate">
            </div>
            {{-- REQUIRED BY --}}
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="items[0][reason]" class="form-control" placeholder="Reason">
            </div>
...
$(document).on('click', '.addRowA', function () {
    ...
    row.find('input, select').each(function () {
        let name = $(this).attr('name').replace(/\d+/, partAIndex);
        $(this).attr('name', name);
...
function () {
    ...
    if (entry_date && item_id && location_id) {
