            ...
            <form id="frm" class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('save-stock-journal') }}">
               ...
               <div class="row">
                  ...
                  <div class="mb-3 col-md-8">
                     ...
                     <input type="text" id="narration" class="form-control" name="narration" placeholder="Narration">
                  </div>
               </div>
               <div class="transaction-table transaction-main-table bg-white table-view shadow-sm border-radius-8 mb-4">
                  <table id="example11" class="table-striped table m-0 shadow-sm table-bordered">
                     ...
                     <tbody>
                        <tr class="font-14 font-heading bg-white">
                           <td class="">
                              <select class="form-control consume_item" name="consume_item[]" data-id="1" id="consume_item_1">
                  ...
                  <table id="example11" class="table-striped table m-0 shadow-sm table-bordered">
                     ...
                     <tbody>
                        <tr class="font-14 font-heading bg-white">
                           <td class="">
                              <select class="form-control generated_item" name="generated_item[]" data-id="1" id="generated_item_1">
                                 <option value="">Item</option>      
                                 @foreach($items as $item)
                                    <option value="{{$item->id}}">{{$item->name}}</option>
                                 @endforeach
                           ...
                           <td class="">
                              <input type="text" name="generated_weight[]" class="form-control generated_weight" data-id="1" id="generated_weight_1" placeholder="Weight">
                           </td>
                           <td class="">
                              <input type="text" name="generated_price[]" class="form-control generated_price" data-id="1" id="generated_price_1" placeholder="Price">
                           </td>
                           <td class="">
                              <input type="text" name="generated_amount[]" class="form-control generated_amount" data-id="1" id="generated_amount_1" placeholder="Amount" readonly>
                           </td>                           
                           <td></td>
                        </tr>
                     </tbody>
