                  ...
                  <div class="mb-4 col-md-4">
                     ...
                     <select class="form-select select2-single" id="party" name="party" required>
                        ...
                        foreach ($party_list as $value) { ?>
                           <option value="<?php echo $value->id; ?>" data-gstin="<?php echo $value->gstin; ?>" data-address="<?php echo $value->address.",".$value->pin_code; ?>" <?php if($value->id==$purchase->party){ echo "selected";}?>><?php echo $value->account_name; ?></option>
                           <?php 
                        } ?>
                     </select>
                     ...
                     <tbody>
                        ...
                        @foreach($PurchaseDescription as $item)
                           <tr id="tr_{{$i}}" class="font-14 font-heading bg-white">
                              ...
                              <td class=" w-min-50">
                                 <input type="text" class="quantity form-control w-100" id="quantity_tr_{{$i}}" name="qty[]" value="{{$item->qty}}" style="text-align:right"/>
                              </td>
                              <td class=" w-min-50">
                              ...
                              <td class=" w-min-50">
                                 <input type="text" class="price w-100 form-control" id="price_tr_{{$i}}" name="price[]" value="{{$item->price}}" style="text-align:right"/></td>
                              <td class=" w-min-50">
                                 <input type="text" id="amount_tr_{{$i}}" class="amount w-100 form-control" name="amount[]"   value="{{$item->amount}}" style="text-align:right" />
                              </td>
                              <td class="">
                        ...
                        <table id="sundry_up_table" class="table-striped table m-0 shadow-sm table-bordered">
                           ...
                           <tbody class="testWrapper">   
                              ...
                              <tr id="billtr_cgst" class="font-14 font-heading bg-white bill_taxes_row sundry_tr" <?php if(!isset($return['CGST'])){?> style="display:none" <?php } ?> >
                                 ...
                                 <td class="w-min-50 ">
                                    <input class="bill_amt w-100 form-control" type="text" name="bill_sundry_amount[]" id="bill_sundry_amount_cgst" data-id="cgst" <?php if(isset($return['CGST'])){?> value="{{$return['CGST'][0]['amount']}}" <?php } ?> style="text-align:right;"></td>
                                 <td></td>
                              </tr>
...
<script>
   ...
   $(".add_more_bill_sundry").click(function() {
      ...
      <?php
      foreach ($billsundry as $value) { ?>
         optionElements += '<option value="<?php echo $value->id; ?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" class="sundry_option_'+add_more_counts+'" id="sundry_option_<?php echo $value->id;?>_'+add_more_counts+'" data-sequence="<?php echo $value->sequence;?>" data-nature_of_sundry="<?php echo $value->nature_of_sundry;?>"><?php echo $value->name; ?></option>';
         <?php 
      } ?>
