            ...
            <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('store-parameterized-configuration') }}">
               ...
               <div class="row">
                  ...
                  <div class="mb-2 col-md-2 parameter_sec" style="display:none">
                     <input type="checkbox" name="alternative_qty" id="alternative_qty" value="1" @if($parameter && $parameter->alternative_qty==1) checked @endif onclick="showAlternativeDiv();"> Alternative Qty
                  </div>
                  <br><br> 
                  <div class="clearfix"></div>                 
   ...
   function callParameterInput(){
      ...
      if($("#no_of_parameter").val()!=""){
         ...
         while(no_of_parameter>=i){
            ...
            let conversion_yes = "";let alternative_unit = "";
            if(para.length>0){
               if(para[j]){
