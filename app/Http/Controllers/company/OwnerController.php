...
class OwnerController extends Controller
{
    public function addOwner()
    {
        ...
        $company = Companies::where('id',$inserted_company_id)->first();
        
        return view('company/addOwner')->with('company_id', $inserted_company_id)->with('business_type', $inserted_business_type)->with('owner_data', $owner_data)->with('owner_delete_data', $owner_delete_data)->with('company', $company);
    }
