                     ...
                     <select id="series_no" class="form-control" name="series_no">
                        ...
                        if(count($mat_series) > 0) {
                           foreach ($mat_series as $value) { ?>
                              <option value="<?php echo $value['branch_series']; ?>" @if($receipt->series_no==$value['branch_series']) selected @endif><?php echo $value['branch_series']; ?></option>
                              <?php 
                           }
                        } ?>
                     </select>
                        ...
                        <div class="mb-2 col-md-2">
                           ...
                           <select id="mode" class="form-control" name="mode">
                              ...
                              <option value="0" @if($receipt->mode==0) selected @endif>IMPS/NEFT/RTGS</option>
                              <option value="1" @if($receipt->mode==1) selected @endif>CASH</option>                        
                              <option value="2" @if($receipt->mode==2) selected @endif>CHEQUE</option>
                           </select>
                        </div>
                        <div class="mb-2 col-md-2">
                    ...
                    <div class="transaction-table transaction-main-table bg-white table-view shadow-sm border-radius-8 mb-4">
                        <table id="example11" class="table-striped table m-0 shadow-sm table-bordered">
                           ...
                           foreach ($receipt_detail as $value) { ?>
                              <tbody>
                                 <tr id="tr_<?php echo $i ?>" class="font-14 font-heading bg-white">
                                    <td class="">
