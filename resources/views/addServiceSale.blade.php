   ...
   <section class="list-of-view-company-section container-fluid">
      <div class="row vh-100">
         ...
         <div class="col-md-12 ml-sm-auto  col-lg-9 px-md-4 bg-mint">
            ...
            <h5 class="table-title-bottom-line px-4 py-3 m-0 bg-plum-viloet position-relative title-border-redius border-divider shadow-sm">Add Service Sales Voucher </h5>
            <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('service-sale.store') }}" id="saleForm">
               @csrf
    ...
    style="{{ $gstApplicable == 1 ? 'display:none' : 'display:none !important' }}">
                                 <td class="w-min-50">
...
if(gstApplicable == "0")
{
    total_item_taxable_amount = total;
}
if(gstApplicable == "0")
{
    billSundryArray.forEach(function(e){
    ...
    total_item_taxable_amount = final_total;
}
