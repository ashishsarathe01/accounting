    ...
    <section class="list-of-view-company-section container-fluid">
        <div class="row vh-100">
            ...
            <div class="col-md-12 ml-sm-auto  col-lg-10 px-md-4 bg-mint">
                ...
                <?php if ($business_type==1) { echo "Proprietor"; }else if($business_type==2){ echo "Partner"; }else if($business_type==3){ echo "Director’s"; } ?>
                    Details
                </h5>
                <form class="bg-white px-4 py-3" method="POST" action="{{ route('submit-add-owner') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input type="text" class="form-control" id="pan" name="pan" placeholder="Enter PAN"  value="<?php if($business_type==1 && $company){ echo $company->pan; } ?>"/>
                        </div>
                        <div class="mb-4 col-md-4">
                        ...
                        <div class="mb-4 col-md-4" id="share_per_div">
                            ...
                            <input class="form-control form-select-lg mb-3" name="share_percentage" id="share_percentage" aria-label="form-select-lg example" placeholder="Share Percentage">
                        </div>
                    </div>
                    ...
                    <div id="joint_patner_div">
                        <p class="font-14 fw-bold font-heading bg-white ">Add New</p>
