            ...
            <div class="d-xxl-flex justify-content-between py-4 px-2 align-items-center">
               <nav aria-label="breadcrumb meri-breadcrumb ">
                  <ol class="breadcrumb meri-breadcrumb m-0  ">
                     ...
                     <li class="breadcrumb-item p-0">
                        <a class="fw-bold font-heading font-12  text-decoration-none" href="#">Purchase By Month</a>
                     </li>
                  </ol>
               </nav>
            </div>
            <div class="table-title-bottom-line position-relative d-flex justify-content-between align-items-center bg-plum-viloet title-border-redius border-divider shadow-sm py-2 px-4">
               <h5 class="master-table-title m-0 py-2">Purchase By Month</h5>
            </div>
...
<script>
   ...
   $(".get_info").click(function(){
      ...
      var financial_year = "{{ request()->segment(3) }}";

      window.location = "{{url('purchase-by-month-detail')}}/"
            + financial_year + "/"
            + from_date + "/"
            + to_date;
   });
