...
/* Make entire group row bold (including amounts) */
.group-row td {
    font-weight: 700 !important;
}
</style>
...
<form method="GET" action="{{ url('receiable/index') }}" class="mt-3">
    ...
    <div class="row">
        ...
        <!-- Show Type -->
        <div class="col-md-4">
    <label class="report-label">Show Report</label>
...
<div class="col-md-4" id="partyDiv"
    ...
    <label class="report-label">Select Party</label>
    <select name="party_id" class="form-control modern-select select2-single">
...
<div class="col-md-4" id="groupDiv"
    ...
    <label class="report-label">Select Group</label>
    <select name="group_id" class="form-control modern-select select2-single">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".group-row").forEach(function (row) {
        ...
        row.addEventListener("click", function (event) {
            ...
            if (event.target.closest("input, button, a, span.record_response, span.log-btn")) return;
