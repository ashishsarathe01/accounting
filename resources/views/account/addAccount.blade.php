            ...
            <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('account.store') }}">
               ...
               <div class="row">
                  ...
                  <div class="mb-4 col-md-4">
                     ...
                     <input type="text" class="form-control" id="print_name" name="print_name" placeholder="Enter here" required/>
                  </div>
                  <div class="mb-4 col-md-4">
                  ...
                  <div class="mb-4 col-md-4">
                     ...
                     <input type="text" class="form-control" id="opening_balance" name="opening_balance" placeholder="Enter Opening Balance" />
                  </div>
                  <div class="mb-4 col-md-4">
               ...
               <div class="row">
                  ...
                  <div class="mb-4 col-md-4 position-relative">
                     ...
                     <input type="date" id="yearly" name="yearly" class="form-control calender-bg-icon calender-placeholder" placeholder="Select date" >
                  </div>
                  <div class="mb-4 col-md-4">
