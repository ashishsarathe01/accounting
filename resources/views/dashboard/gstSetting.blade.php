               ...
               <h5 class="master-table-title m-0 py-2">GST Configuration</h5>
                ...
                <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('gst-setting.store') }}">
                    ...
                    <div class="bg-white px-4 py-4 border-divider rounded-bottom-8 shadow-sm mb-4">
                        ...
                        foreach ($company_data as $value) { ?>
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="{{$value->gst }}" id="gst_no" name="gst_no[0][]" placeholder="Enter here" />
                                </div>
                                <div class="mb-4 col-md-4">
                                ...
                                <div class="calender-administrator mb-4 col-md-4">
                                    ...
                                    <input type="date" id="validity_from" name="validity_from[0][]" value="{{$value->date_of_incorporation }}" class="form-control calender-bg-icon calender-placeholder" placeholder="From date">
                                </div>
                                <div class="calender-administrator mb-4 col-md-4">
                                    <label for="name" class="form-label font-14 font-heading">Validity To</label>
                                    <input type="date" id="validity_to" name="validity_to[0][]" class="form-control calender-bg-icon calender-placeholder" placeholder="To date">
                                </div>
                                <div class="mb-4 col-md-4">
                                    <label for="name" class="form-label font-14 font-heading">Address</label>
                                    <input type="text" class="form-control" id="address" value="{{$value->address }}" name="address[0][]" placeholder="Enter address" />
                                </div>
                                <div class="mb-4 col-md-4">
                                    <label for="contact-number" class="form-label font-14 font-heading">State</label>
                                    <select class="form-select form-select-lg" name="state[0][]" id="state" aria-label="form-select-lg example">
                                        <option value="">Select </option>
                                        <?php
                                ...
                                <div class="mb-4 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="pincode" value="{{$value->pin_code }}" name="pincode[0][]" placeholder="Enter pincode" />
                                </div>
                                <div class="mb-4 col-md-4">
                                ...
                                <div class="mb-4 col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="mat_center[0][]" placeholder="Enter mat center" />
                                </div>
                                <div class="mb-4 col-md-4">
                                    <label for="name" class="form-label font-14 font-heading">Series</label>
                                    <input type="text" class="form-control" name="series[0][]" placeholder="Enter series" />
                                </div>
                                <div class="mb-4 col-md-4">
                                    <label for="name" class="form-label font-14 font-heading">Invoice Start from</label>
                                    <input type="text" class="form-control" name="invoice_start_from[0][]" placeholder="Enter " />
                                </div>
                            </div>
                        <?php } ?>
                        <!-- E - Invoice -->
                        ...
                        <a onclick="add_more_branch('1',0);" class="add_more_branch btn btn-sm-black d-block ms-auto add-branch-toogle">ADD BRANCH
                        </a>
