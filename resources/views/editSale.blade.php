                     ...
                     <tbody>
                        ...
                        @foreach($SaleDescription as $item)
                           <tr id="tr_{{$i}}" class="font-14 font-heading bg-white">
                              ...
                              <td class="w-min-50">
                                 <input type="number" class="quantity w-100 form-control" id="quantity_tr_{{$i}}" name="qty[]" value="{{$item->qty}}" placeholder="Quantity"  style="text-align:right;" >
                              </td>
                              <td class="w-min-50">
                              ...
                              <td class="w-min-50">
                                 <input type="number" class="price form-control" id="price_tr_{{$i}}" name="price[]" value="{{$item->price}}" placeholder="Price"  style="text-align:right;">
                              </td>
                              <td class="">
                                 <input type="number" id="amount_tr_{{$i}}" class="amount w-100 form-control" name="amount[]" value="{{$item->amount}}" placeholder="Amount"  style="text-align:right;">
                              </td>
