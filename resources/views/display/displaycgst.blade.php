                ...
                <div class="d-md-flex justify-content-between py-4 px-2 align-items-center">
                    <nav aria-label="breadcrumb meri-breadcrumb ">
                        <ol class="breadcrumb meri-breadcrumb m-0  ">
                            ...
                            <li class="breadcrumb-item p-0">
                                <a class="font-heading font-12  text-decoration-none" href="./display-dutie-taxes.html">
                                    Duties & Taxes</a>
                            </li>
                            <li class="breadcrumb-item p-0">
                    ...
                    <div class="d-md-flex d-block">
                        <div class="calender-administrator my-2 my-md-0  w-min-230">
                            <input type="date" id="customDate" class="form-control calender-bg-icon calender-placeholder" placeholder="From date" required>
                        </div>
                        <div class="calender-administrator   w-min-230 ms-md-4">
                            <input type="date" id="customDate" class="form-control calender-bg-icon calender-placeholder" placeholder="To date" required>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="" class="table-striped table m-0 shadow-sm ">
                        <thead>
                            <tr class=" font-12 text-body bg-light-pink ">
                                <th class="w-min-120 border-none bg-light-pink text-body">Month </th>
                                <th class="w-min-120 border-none bg-light-pink text-body ">Debit (Rs.)</th>
                                <th class="w-min-120 border-none bg-light-pink text-body ">Credit(Rs.)</th>
                                <th class="w-min-120 border-none bg-light-pink text-body ">Balance(Rs.)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120"><a class="text-decoration-none text-primary" href="{{ route('dutytax.index') }}">April</a> </td>
                                <td class="w-min-120 ">2000 </td>
                                <td class="w-min-120 ">4000 </td>
                                <td class="w-min-120 ">6000 </td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">May</td>
                                <td class="w-min-120 ">2000</td>
                                <td class="w-min-120 ">4000</td>
                                <td class="w-min-120 ">6000</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">June</td>
                                <td class="w-min-120 ">2000</td>
                                <td class="w-min-120 ">4000</td>
                                <td class="w-min-120 ">6000</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">July</td>
                                <td class="w-min-120 ">2000</td>
                                <td class="w-min-120 ">4000</td>
                                <td class="w-min-120 ">6000</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">August</td>
                                <td class="w-min-120 ">2000</td>
                                <td class="w-min-120 ">4000</td>
                                <td class="w-min-120 ">6000</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">September</td>
                                <td class="w-min-120 ">2000</td>
                                <td class="w-min-120 ">4000</td>
                                <td class="w-min-120 ">6000</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">October</td>
                                <td class="w-min-120 ">2000</td>
                                <td class="w-min-120 ">4000</td>
                                <td class="w-min-120 ">6000</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120">November</td>
                                <td class="w-min-120 ">2000</td>
                                <td class="w-min-120 ">4000</td>
                                <td class="w-min-120 ">6000</td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                ...
                                <td class="w-min-120 fw-bold">20,000</td>
                                <td class="w-min-120 fw-bold">40,000</td>
                                <td class="w-min-120 "></td>
                            </tr>
                            <tr class=" font-14 font-heading bg-white">
                                <td class="w-min-120" colspan="3"></td>
                                <td class="w-min-120 fw-bold">Closing Bal: 2,00,000</td>
                            </tr>
