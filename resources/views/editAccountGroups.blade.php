                ...
                @csrf
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-3">
                            ...
                            <input type="text" class="form-control" value="{{ $editGroup->name }}" name="name" id="name" placeholder="Enter name " />
                        </div>
                        <div class="mb-3 col-md-3">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <select class="form-select " id="heading_as_sch" name="heading_as_sch" disabled>
                                <option value="">Select</option>
                                <option value="1" <?php echo $editGroup->heading_as_sch =='1' ? 'selected':'';?>>Shareholders Fund</option>
                                <option value="2" <?php echo $editGroup->heading_as_sch =='2' ? 'selected':'';?>>Current Liabilities</option>
                                <option value="3" <?php echo $editGroup->heading_as_sch =='3' ? 'selected':'';?>>Non Current Liabilities</option>
                                <option value="4" <?php echo $editGroup->heading_as_sch =='4' ? 'selected':'';?>>Current Assets</option>
                                <option value="5" <?php echo $editGroup->heading_as_sch =='5' ? 'selected':'';?>>Non Current Assets</option>
                            </select>
                        </div>
                        <div class="mb-3 col-md-3">
