...
<div class="list-of-view-company">
   <section class="list-of-view-company-section container-fluid py-3">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form method="POST" action="{{ route('purchase-bill-export') }}" class="row g-4">
                @csrf

                <div class="col-md-4">
                    <label class="form-label fw-semibold">From Date</label>
                    <input type="date" name="from_date" class="form-control"
                           value="{{ old('from_date', date('Y-m-d')) }}" required>
                </div>
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form method="POST" action="{{ route('purchase-tally-export') }}" class="row g-4">
                @csrf
