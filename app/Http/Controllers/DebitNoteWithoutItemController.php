...
use Session;
use DB;
class DebitNoteWithoutItemController extends Controller
{
    /**
    ...
    public function create()
    {
      ...
      $items = Accounts::select('id','account_name')
               ...
               ->orderBy('account_name')
               ->get();
      return view('debit_note_without_item')->with('date', $bill_date)->with('mat_series', $mat_series)->with('vendors', $vendors)->with('items', $items)->with('company_gst', $companyData->gst);
    }
