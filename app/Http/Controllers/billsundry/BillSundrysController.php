...
class BillSundrysController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $account->sundry_percent = $request->input('sundry_percent');
        $account->sundry_percent_date = $request->input('sundry_percent_date');
        $account->effect_gst_calculation = $request->input('effect_gst_calculation');
