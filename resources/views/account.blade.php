                ...
                <div class="   bg-white table-view shadow-sm">
                    <table id="example" class="table-striped table m-0 shadow-sm">
                        ...
                        <tr class=" font-12 text-body bg-light-pink ">
                                ...
                                <th class="w-min-120 border-none bg-light-pink text-body ">Address </th>
                                <th class="w-min-120 border-none bg-light-pink text-body ">Pincode </th>
                                <th class="w-min-120 border-none bg-light-pink text-body ">State </th>
                        ...
                        <tbody>
                            ...
                            foreach ($account as $value) { ?>
                                <tr class="font-14 font-heading bg-white">
                                    ...
                                    <td class="w-min-120"><?php echo $value->under_group ?></td>
                                    <td class="w-min-120"><?php echo $value->gstin ?></td>
                                    <td class="w-min-120"><?php echo $value->address ?></td>
                                    <td class="w-min-120"><?php echo $value->pin_code ?></td>
                                    <td class="w-min-120"><?php echo $value->state ?></td>
