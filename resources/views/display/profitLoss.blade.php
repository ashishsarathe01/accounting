               ...
               <div class="col-md-6  font-14 p-0 border-bottom-divider">
                  ...
                  <div class="row p-0 m-0">
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">Opening Stock
                        <span class="ms-auto">
                           @php
                              echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['opening_stock']);
                           @endphp
                          </span>
                     </div>
                     <div class="col-md-12 fw-500 font-14  px-3 py-12 border-bottom-divider">
                        <a class="text-decoration-none text-primary fw-500" href="{{url('purchase-by-month-detail')}}/{{$data['financial_year']}}/{{$from_date}}/{{$to_date}}">
                           <p class="d-flex m-0">Purchase
                              <span class="ms-auto">
                                 @php
                                    echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['tot_purchase_amt']);
                                 @endphp
                              </span>
                           </p>
                           <p class="d-flex m-0 py-12">
                              ...
                              <span class="ms-auto">
                                 @php
                                    echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['tot_purchase_return_amt']);
                                 @endphp
                              </span>
                           </p>
                           ...
                           <p class="d-flex m-0 ">
                              <span class="ms-auto">
                                 @php
                                    ...
                                    echo App\Http\Controllers\display\ProfitLossController::moneyFormat($total_net_purchase);
                                 @endphp
                              </span>
                           </p>
                        </a>
                     ...
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                        ...
                        <span class="ms-auto">
                           <a href="{{url('account-balance-by-group/12')}}/{{$data['financial_year']}}/{{$from_date}}/{{$to_date}}">
                              @php
                                 echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['direct_expenses']);
                              @endphp
                           </a>
                        </span>
                     </div>
                     ...
                     if($balance < 0) {
                        ...
                        <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                           ...
                           <span class="ms-auto">
                              @php
                                 echo App\Http\Controllers\display\ProfitLossController::moneyFormat(str_replace("-","",$gross_profit));
                              @endphp
                           </span>
                        </div>
                        <?php 
                     ...
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">Total
                        <span class="ms-auto">
                           @php
                              ...
                              echo App\Http\Controllers\display\ProfitLossController::moneyFormat($first_total);
                           @endphp                           
                        </span>
                     </div>
                     ...
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                        ...
                        <span class="ms-auto">                           
                           <a href="{{url('account-balance-by-group/15')}}/{{$data['financial_year']}}/{{$from_date}}/{{$to_date}}">
                              @php
                                 echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['indirect_expenses']);
                              @endphp
                           </a>
                        </span>
                     </div>
                     ...
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                        ...
                        <span class="ms-auto">
                           @php
                              echo App\Http\Controllers\display\ProfitLossController::moneyFormat($nett_profit);
                           @endphp
                        </span>
                           <?php
                        }else{
                     ...
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">Total
                        <span class="ms-auto">
                           @php
                              echo App\Http\Controllers\display\ProfitLossController::moneyFormat($nett_final_amount);
                           @endphp
                        </span>
                     </div>
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider h-46"></div>
                  ...
                  <div class="row p-0 m-0">
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">Closing Stock
                           ...
                           <span class="ms-auto">
                              <a href="{{url('itemledger-filter')}}?&items_id=all&from_date={{$from_date}}&to_date={{$to_date}}">@php
                                 echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['closing_stock']);
                              @endphp</a>
                           </span>
                     ...
                     <div class="col-md-12 fw-500 font-14  px-3 py-12 border-bottom-divider">
                        <a class="text-decoration-none text-primary fw-500" href="{{url('sale-by-month-detail')}}/{{$data['financial_year']}}/{{$from_date}}/{{$to_date}}">
                           ...
                           <span class="ms-auto">
                           @php
                              echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['tot_sale_amt']);
                           @endphp
                           </span>
                           </p>                        
                           <p class="d-flex m-0 py-12">Sale Return
                              <span class="ms-auto">
                                 @php
                                    echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['tot_sale_return_amt']);
                                 @endphp
                              </span>
                           </p>
                           <p class="d-flex m-0 py-12 align-items-center">
                           ...
                           <p class="d-flex m-0 ">
                              <span class="ms-auto">
                                 @php
                                    ...
                                    echo App\Http\Controllers\display\ProfitLossController::moneyFormat($total_net_sale);
                                 @endphp
                     ...
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                        ...
                        <span class="ms-auto"><a href="{{url('account-balance-by-group/13')}}/{{$data['financial_year']}}/{{$from_date}}/{{$to_date}}">
                           @php
                              echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['direct_income']);
                           @endphp</a></span>
                     </div>
                     <?php                     
                     if($gross_loss > 0) {?>
                        <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                           ...
                           <span class="ms-auto">
                              @php
                                 echo App\Http\Controllers\display\ProfitLossController::moneyFormat($gross_loss);
                              @endphp
                           </span>
                        </div>
                        <?php 
                     ...
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                        ...
                        if($gross_profit>0){ ?>
                           ...
                           <span class="ms-auto">
                              @php
                                 echo App\Http\Controllers\display\ProfitLossController::moneyFormat($gross_profit);
                              @endphp
                           </span>
                           <?php
                        }else{
                     ...
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                        ...
                        <span class="ms-auto">
                           <a href="{{url('account-balance-by-group/14')}}/{{$data['financial_year']}}/{{$from_date}}/{{$to_date}}">
                           @php
                              echo App\Http\Controllers\display\ProfitLossController::moneyFormat($data['indirect_income']);
                           @endphp
                           </a>
                        </span>
                     </div>
                     <div class="col-md-12 fw-500 font-14 d-flex px-3 py-12 border-bottom-divider">
                        ...
                        <span class="ms-auto">
                           @php
                              echo App\Http\Controllers\display\ProfitLossController::moneyFormat($nett_loss);
                           @endphp
                        </span>
                        <?php 
                        }else{
