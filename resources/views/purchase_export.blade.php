   ...
   <section class="list-of-view-company-section container-fluid py-3">
        <div class="row">
         ...
         <div class="col-md-12 col-lg-9 px-md-4 bg-light">
            ...
            <h5 class="table-title-bottom-line px-4 py-3 m-0 bg-plum-viloet position-relative 
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('purchase-export') }}" class="row g-4">
                        @csrf
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex mt-2">
                                <div class="form-check me-4">
                                    <input class="form-check-input" type="radio" name="purchase_type" id="purchase_local"
                                        value="LOCAL" {{ old('purchase_type','LOCAL') == 'LOCAL' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="purchase_local">LOCAL</label>
                                </div>

                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="purchase_type" id="purchase_center"
                                        value="CENTER" {{ old('purchase_type') == 'CENTER' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="purchase_center">CENTER</label>
                                </div>
                            </div>
                        </div>
         ...
         <!-- RIGHT SIDE SHORTCUT KEYS COLUMN -->
