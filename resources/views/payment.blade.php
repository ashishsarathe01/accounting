        ...
        <div class="row vh-100">
            ...
            <div class="col-md-12 ml-sm-auto  col-lg-8 px-md-4 bg-mint">
                ...
                <div class="table-title-bottom-line position-relative d-flex justify-content-between align-items-center bg-plum-viloet title-border-redius border-divider shadow-sm py-2 px-4">
                    ...
                    <a href="{{ route('payment.create') }}" class="btn btn-xs-primary">
                        ADD
                        ...
                        <tbody>
                            ...
                            foreach ($payment as $value) { ?>
                                <tr class="font-14 font-heading bg-white">
                                    ...
                                    <td class="w-min-120 "><?php echo $value->debit;
                                     $tot_dbt = $tot_dbt+$value->debit; ?></td>
                                    <td class="w-min-120 "><?php echo $value->credit;
                                     $tot_crt = $tot_crt+$value->credit; ?></td>
                                    <td class="w-min-120 "><?php echo $value->mode ?></td>
                            ...
                            <tr class="font-14 font-heading bg-white">
                                ...
                                <td class="w-min-120 fw-bold font-heading"><?php echo $tot_dbt;?></td>
                                <td class="w-min-120 fw-bold font-heading"><?php echo $tot_crt;?></td>
                                <td class="w-min-120"></td>
                                <td class="w-min-120 "></td>
                                </td>
                            </tr>
