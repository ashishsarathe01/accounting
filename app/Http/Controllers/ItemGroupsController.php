...
class ItemGroupsController extends Controller
{
   /**
    ...
    {
        $itemgroups = ItemGroups::where('delete', '=', '0')->get();
        return view('accountItemGroup')->with('itemgroups', $itemgroups);
    }
    ...
    {
        return view('addAccountItemGroup');
    }
    ...
    public function edit($id)
    {
        ...
        return view('editAccountItemsGroup')->with('itemsgroup', $itemsgroup);
    }
    /**
