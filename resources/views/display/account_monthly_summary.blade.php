            ...
            <div class="d-xxl-flex justify-content-between py-4 px-2 align-items-center">
               <nav aria-label="breadcrumb meri-breadcrumb ">
                  <ol class="breadcrumb meri-breadcrumb m-0  ">
                     ...
                     <li class="breadcrumb-item p-0">
                        <a class="fw-bold font-heading font-12  text-decoration-none" href="{{url('profitloss')}}">Account Balance By Group</a>
                     </li>                     
                     <li class="breadcrumb-item p-0">
                        <a class="fw-bold font-heading font-12  text-decoration-none" href="#">Account - Monthly Summary</a>
                     </li>
                  </ol>
               </nav>
            </div>
            <div class="table-title-bottom-line position-relative d-flex justify-content-between align-items-center bg-plum-viloet title-border-redius border-divider shadow-sm py-2 px-4">
               <h5 class="master-table-title m-0 py-2">Account - Monthly Summary</h5>
            </div>
               ...
               <table class="table table-bordered">
                  ...
                  <tbody>
                     ...
                     @foreach($data as $key => $value)
                        <tr class="get_info" data-id="{{$account_id}}" data-from_date="{{$value['from_date']}}" data-to_date="{{$value['to_date']}}" style="cursor: pointer;">
...
<script>
   $(document).ready(function(){
      $(".get_info").click(function(){
         window.location = "{{url('accountledger-filter')}}/?party="+$(this).attr('data-id')+"&from_date="+$(this).attr('data-from_date')+"&to_date="+$(this).attr('data-to_date');
      });
   });
</script>
@endsection