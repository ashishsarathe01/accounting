    ...
    <div style="padding:8px;">
        ...
        <table style="width:100%;border-collapse:collapse;">
            ...
            <tr>
                ...
                <th style="border:1px solid #999;padding:6px;width:6%;text-align:left;">
                    Mode
                </th>

                <th style="border:1px solid #999;padding:6px;width:28%;text-align:left;">
                    Vehicle / Trans<br>
                    Doc No &amp; Dt.
                </th>

                <th style="border:1px solid #999;padding:6px;width:8%;text-align:left;">
                    From
                </th>

                <th style="border:1px solid #999;padding:6px;width:17%;text-align:left;">
                    Entered Date
                </th>
                ...
                <th style="border:1px solid #999;padding:6px;width:10%;text-align:left;">
                    CEWB No.<br>(If any)
                </th>

                <th style="border:1px solid #999;padding:6px;width:12%;text-align:left;">
                    Multi Veh.Info<br>(If any)
                </th>

                <th style="border:1px solid #999;padding:6px;width:5%;text-align:left;">
                    Portal
                </th>
