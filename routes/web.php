...
Route::group(['middleware' => ['merchantloginstatus']], function () {
    ...
    Route::post('gst-setting-update', [GstSettingController::class, 'update'])->name('gst-setting.updates');
    ...
    Route::middleware(['gst.configured'])->group(function () {
        //AccountHeading CRUD
        ...
        [ProfitLossController::class, 'purchaseByMonth'])->name('purchase-by-month');
...
Route::post('gstr2a-reconciliation-detail', [GSTR2AController::class, 'gstr2aReconciliationDetail'])
    ->name('gstr2a-reconciliation-detail');
        ...
        Route::get('/profit-report', [ManageRateController::class, 'profitReport'])
        ->name('profit.report');
