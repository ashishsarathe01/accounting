   ...
   <section class="list-of-view-company-section container-fluid">
      <div class="row vh-100">
         ...
         <div class="col-md-12 ml-sm-auto  col-lg-9 px-md-4 bg-mint">
            ...
            <h5 class="table-title-bottom-line px-4 py-3 m-0 bg-plum-viloet position-relative title-border-redius border-divider shadow-sm">Import Journal</h5>
            ...
            <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" id="upload_form" multipart enctype="multipart/form-data">
               ...
               <div class="row">
                  <div class="mb-5 col-md-5">
                     <label for="name" class="form-label font-14 font-heading">Upload CSV File *</label> <strong>(<a href="{{ URL::asset('public/csv-template/MA - JournalCSV.csv')}}">Download Template</a>)</strong>
...
<script type="text/javascript">
   ...
   $('form#upload_form').on('submit', function(e){
      ...
      $("#cover-spin").show();
      $.ajax({
         url: '{{ URL::route("journal-import-process") }}',
         type: 'POST',
         data: formData,
         async: true,
         cache: false,
