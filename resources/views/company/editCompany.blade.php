         ...
         <div class="col-md-12 ml-sm-auto  col-lg-10 px-md-4 bg-mint">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb m-0 py-4 px-2  ">
                  ...
                  <li class="breadcrumb-item">
                     <a class="fw-bold font-heading font-12 text-decoration-none" href="#">Edit Company</a>
                  </li>
               </ol>
            </nav>
            @if (session('success'))
            ...
            @endif
            <h5 class="table-title-bottom-line px-4 py-3 m-0 bg-plum-viloet position-relative title-border-redius">Company Info</h5><br>
            <ul class="nav nav-fill nav-tabs" role="tablist">
               ...
               <li class="nav-item" role="presentation">
                  <a class="nav-link" id="fill-tab-1" data-bs-toggle="tab" href="#fill-tabpanel-1" role="tab" aria-controls="fill-tabpanel-1" aria-selected="false">Owner</a>
               </li>
               <li class="nav-item" role="presentation">
            ...
            <div class="tab-content pt-5" id="tab-content">
               ...
               <div class="tab-pane" id="fill-tabpanel-1" role="tabpanel" aria-labelledby="fill-tab-1">
                  ...
                  <div id="joint_patner_div">
                     <p class="font-14 fw-bold font-heading bg-white ">Joint Partner/Director <button class="btn btn-info add_new_owner">Add New Owner</button></p> 
