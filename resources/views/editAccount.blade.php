                ...
                <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('account.update') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input type="text" class="form-control" id="account_name" value="{{account->account_name}}" name="account_name" placeholder="Enter account name" />
                        </div>
                        <div class="mb-4 col-md-4">
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <select class="form-select form-select-lg " name="under_group" id="under_group" aria-label="form-select-lg example">
                                ...
                                <option value="Expense">Expenses (Direct/Mfg.)</option>
                                <option value="Duties">Expenses (Indirect/Admn.)</option>
                                <option value="taxes">FIXED ASSETS</option>
                                <option>Income (Direct/Opr.)</option>
                                <option>Income (Indirect)</option>
                            </select>
                        </div>
                        <div class="mb-4 col-md-4">
                            ...
                            <select class="form-select form-select-lg " name="under_group_s" id="under_group_s" aria-label="form-select-lg example">
                                <option value="">Select </option>
                                <option value="Bank Accounts">Current Assets</option>
                                <option value="Cash-in-hand">Current Liabilities</option>
                                <option value="Duties & taxes">Non Current Assets</option>
                                <option value="Expense">Non Current Liabilities</option>
                                <option value="Duties">Shareholders Fund</option>
                            </select>
                        </div>
                        <div class="mb-4 col-md-4">
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <select class="form-select form-select-lg " name="state" id="state" aria-label="form-select-lg example">
                                ...
                                <option>CAndhra Pradesh</option>
                                <option>Arunachal Pradesh</option>
                                <option>Assam, Bihar</option>
