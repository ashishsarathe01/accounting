                    ...
                    <div class="bg-white px-4 py-4 border-divider rounded-bottom-8 shadow-sm mb-4">
                        ...
                        foreach ($company_data as $value) { 
                           ...
                           <div class="mb-4 col-md-4">
                              ...
                              <input type="text" class="form-control" name="authorized_signatory_1[0][]" placeholder="Authorized Signatory 1" >
                           </div>
                           <div class="mb-4 col-md-4">
                              <label for="name" class="form-label font-14 font-heading">Authorized Signatory Pan No. 1</label>
                              <input type="text" class="form-control" name="authorized_signatory_pan_no_1[0][]" placeholder="Authorized Signatory Pan No. 1" >
                           </div>
                           <div class="clearfix"></div>
                           <div class="mb-4 col-md-4">
                              <label for="name" class="form-label font-14 font-heading">Authorized Signatory 2</label>
                              <input type="text" class="form-control" name="authorized_signatory_2[0][]" placeholder="Authorized Signatory 2" >
                           </div>
                           <div class="mb-4 col-md-4">
                              <label for="name" class="form-label font-14 font-heading">Authorized Signatory Pan No. 2</label>
                              <input type="text" class="form-control" name="authorized_signatory_pan_no_2[0][]" placeholder="Authorized Signatory Pan No. 2" >
                           </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="d-sm-flex mb-4">
                            <div class="me-4">
                                <input type="text" class="form-control" name="gst_username[0][]" placeholder="GST UserName" >
                            </div>
                        </div> 
                        ...
                        <div class="row e-waybill-yes">
                            ...
                            <div class="mb-4 col-md-4">
                                <label for="name" class="form-label font-14 font-heading">Password</label>
                                <input type="password" class="form-control" id="ewaybill_password_0" name="ewaybill_password[0][]" placeholder="Enter password" />
                            </div>
                        </div>
                        <!-- addbranch toggle -->
