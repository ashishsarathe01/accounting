            ...
            <div class="col-md-12 ml-sm-auto col-lg-10 px-md-4 bg-mint">
                ...
                <div class="table-title-bottom-line position-relative d-flex justify-content-between
                    ...
                    <h5 class="transaction-table-title m-0 py-2">
                        Part Life Chart – Manage Locations
                    </h5>
                    ...
                    <a href="{{ route('part-life.locations.add') }}" class="btn btn-xs-primary">
                        ADD
                ...
                <div class="transaction-table bg-white table-view shadow-sm mt-4">
                    <table class="table-striped table m-0 shadow-sm location_table">
                        <thead>
                            <tr class="font-12 text-body bg-light-pink">
                                <th class="w-min-120 border-none">Location Name</th>
                            ...
                            @forelse($locations as $location)
                                <tr class="font-14 text-body">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('part-life.locations.edit', $location->id) }}"
...
{{-- Delete Modal --}}
<div class="modal fade" id="locationDeleteModal" tabindex="-1">
        ...
        <div class="modal-content p-4 border-divider border-radius-8">
            ...
            <form method="POST" id="deleteForm">
                ...
                <div class="modal-body text-center p-0">
                    ...
                    <h5 class="mb-3 fw-normal">Delete this location</h5>
...
$(document).on("click", ".delete", function () {
    let id = $(this).data("id");
    let url = "{{ route('part-life.locations.delete', ':id') }}".replace(':id', id);
...
$("#search").on("keyup", function () {
    ...
    $(".location_table tbody tr").filter(function () {
