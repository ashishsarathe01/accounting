        ...
        <div class="row vh-100">
            ...
            <div class="col-md-12 ml-sm-auto col-lg-10 px-md-4 bg-mint">
                ...
                <div class="position-relative table-title-bottom-line d-flex justify-content-between align-items-center bg-plum-viloet title-border-redius border-divider shadow-sm py-2 px-4">
                    ...
                    <a
                        href="{{ route('admin.company-sale-types.create') }}"
                        class="btn btn-xs-primary"
                    >

                        ADD

                        <svg class="position-relative ms-2"
                ...
                <div class="bg-white table-view shadow-sm">
                    ...
                    <table
                        id="example"
                        class="table-striped table m-0 shadow-sm"
                    >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(!$isAssigned)
                                            ...
                                            <a href="{{ route('admin.company-sale-types.edit',$saleType->id) }}">

                                                <img
                                                    src="{{ asset('public/assets/imgs/edit-icon.svg')}}"
                                                    class="px-1"
                                                    alt="Edit"
                                                >
                                            ...
                                            <button
                                                type="button"
                                                class="border-0 bg-transparent delete-sale-type"
                                                data-id="{{ $saleType->id }}"
                                            >

                                                <img
                                                    src="{{ asset('public/assets/imgs/delete-icon.svg')}}"
                                                    class="px-1"
                                                    alt="Delete"
                                                >
...
<div class="modal fade" id="delete_sale_type" tabindex="-1">
    ...
    <div class="modal-dialog w-360 modal-dialog-centered">
        ...
        <div class="modal-content p-4 border-divider border-radius-8">
            ...
            <form
                method="POST"
                action="{{ route('admin.company-sale-types.delete') }}"
            >
                ...
                <div class="modal-body text-center p-0">
                    ...
                    <img
                        class="delete-icon mb-3 d-block mx-auto"
...
$(document).ready(function(){
    ...
    $('#example').DataTable({
        ...
        language: {
            ...
            emptyTable: "No Company Sale Types Available"
