...
<form action="{{ route('box.sale.order.update',$saleOrder->id) }}"
      method="POST">
            ...
            <select name="party_id"
                ...
                @foreach($parties as $party)
                    ...
                    <option value="{{ $party->id }}"
                        {{ $saleOrder->party_id == $party->id ? 'selected' : '' }}>
...
@foreach($saleOrderItems as $key => $row)
...
$(document).ready(function () {
    ...
    function refreshActionButtons()
    {
        ...
        let totalRows =
            $('#saleOrderTable tbody tr').length;
        ...
        {
            $('#saleOrderTable tbody tr').each(function(){
