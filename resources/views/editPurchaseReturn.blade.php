         ...
         <div class="col-md-12 ml-sm-auto  col-lg-9 px-md-4 bg-mint">
               ...
               <nav aria-label="breadcrumb meri-breadcrumb ">
                  <ol class="breadcrumb meri-breadcrumb m-0  ">
                     ...
                     <li class="breadcrumb-item p-0">
                        <a class="fw-bold font-heading font-12  text-decoration-none" href="#">Add Purchase Return</a>
                     </li>
                  </ol>
               </nav>
            </div>
            <h5 class="table-title-bottom-line px-4 py-3 m-0 bg-plum-viloet position-relative title-border-redius border-divider shadow-sm">Add Purchase Return</h5>
            <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('purchase-return-update') }}" id="purchaseReturnForm">
               ...
               <div class="row">
                     ...
                     <select id="series_no" name="series_no" class="form-select" required>
                        ...
                        if(count($mat_series) > 0) {
                           foreach ($mat_series as $value) { ?>
                              <option value="<?php echo $value['branch_series']; ?>" <?php if($purchase_return->series_no==$value['branch_series']){ echo "selected";} ?>><?php echo $value['branch_series']; ?></option>
                              <?php 
                           }
                        } ?>
                     </select>
                     ...
                     <select name="material_center" class="form-select" required>
                        ...
                        if(count($mat_center) > 0) {
                           foreach ($mat_center as $value) { ?>
                              <option value="<?php echo $value['branch_matcenter']; ?>" <?php if($purchase_return->material_center==$value['branch_matcenter']){ echo "selected";} ?>><?php echo $value['branch_matcenter']; ?></option>
                              <?php 
                           }
                        } ?>
                     </select>
                  ...
                  <div class="mb-4 col-md-4">
                     <label for="purchase_return_no" class="form-label font-14 font-heading">Purchase Return No.</label>
                     <input type="text" id="purchase_return_no" class="form-control" name="purchase_return_no" value="{{$purchase_return->purchase_return_no}}" required readonly>
                  </div>
               </div>
                     ...
                     <tbody>
                        ...
                        @foreach($purchase_return_description as $item)
                           ...
                           <tr id="tr_@php echo $i; @endphp" class="font-14 font-heading bg-white">
                              ...
                              <td class="">
                                 <select onchange="call_fun('tr_@php echo $i; @endphp');" class="border-0 form-select  goods_items" id="goods_discription_tr_@php echo $i; @endphp" name="goods_discription[]" required data-id="@php echo $i; @endphp">
                                    <option value="">Select</option>
                                 </select>
                              </td>                              
                              <td class=" w-min-50">
