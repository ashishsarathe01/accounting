         ...
         <div class="col-md-12 ml-sm-auto  col-lg-10 px-md-4 bg-mint">
            ...
            <nav>
               <ol class="breadcrumb m-0 py-4 px-2 px-md-0 font-12">
                  ...
                  <li class="breadcrumb-item fw-bold font-heading" aria-current="page">Stock Journal</li>
               </ol>
            </nav>
               ...
               <form class="" id="frm" method="get" action="{{ route('stock-journal') }}">
                  ...
                  <div class="d-md-flex d-block">
                     <div class="calender-administrator my-2 my-md-0">
                        <input type="date" id="from_date" class="form-control calender-bg-icon calender-placeholder" placeholder="From date" required name="from_date" value="<?php if(isset($_GET['from_date'])){ echo $_GET['from_date'];}else{ echo date('Y-m-').'01';}?>">
                     </div>
                     <div class="calender-administrator ms-md-2">
                        <input type="date" id="to_date" class="form-control calender-bg-icon calender-placeholder" placeholder="To date" required name="to_date" value="<?php  if(isset($_GET['to_date'])){ echo $_GET['to_date']; }else{ echo date('Y-m-t');}?>">
                     </div>
                     <div class="calender-administrator ms-md-2">
