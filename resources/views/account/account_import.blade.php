   ...
   <section class="list-of-view-company-section container-fluid">
      <div class="row vh-100">
         ...
         <div class="col-md-12 ml-sm-auto  col-lg-9 px-md-4 bg-mint">
            ...
            @if($upload_log==1)
               <p style="font-size:20px;text-align:center;">Total Account : {{$total_count}}</p>
               <p style="font-size:20px;text-align:center;color:green">Insert Account : {{$success_count}}</p>
               <p style="font-size:20px;text-align:center;color:red">Failed Account : {{$failed_count}}</p>
               @if($incomplete_status_count>0)
               <p style="font-size:20px;text-align:center;color:red">Incomplete Account : {{$incomplete_status_count}}</p>
               @endif
