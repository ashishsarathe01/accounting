...
<div class="table-title-bottom-line position-relative d-flex justify-content-between align-items-center bg-plum-viloet title-border-redius border-divider shadow-sm py-2 px-4">
    <h5 class="transaction-table-title m-0 py-2">Tasks Assigned To You</h5>
...
<form method="GET" action="{{ route('task.myTasks') }}">
    ...
    {{-- Reset --}}
    <div class="col-md-2">
        <a href="{{ route('task.myTasks') }}" class="btn btn-border-body w-100">
            Reset
        </a>
    </div>
            ...
            @foreach($tasks as $task)
                ...
                <tr class="font-14 font-heading bg-white {{ $isOverdue ? 'table-danger' : '' }}">
                    ...
                    <td class="text-center">
                        <a title="View Task"
                           href="{{ route('task.detail', $task->id) }}?from=my-tasks">
