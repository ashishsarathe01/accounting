                  ...
                  <table id="example11" class="table-striped table m-0 shadow-sm table-bordered">
                     ...
                     <tbody>
                        <tr id="tr_1" class="font-14 font-heading bg-white">
                           ...
                           <td class="w-min-50">
                              <input type="text" class="quantity w-100 form-control" id="quantity_tr_1" name="qty[]" placeholder="Quantity" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="text-align:right;" data-id="1"/>
                           </td>
                           <td class="w-min-50">                              
                           ...
                           <td class="w-min-50">
                              <input type="text" class="price form-control" id="price_tr_1" name="price[]" placeholder="Price" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="text-align:right;" data-id="1"/>
                           </td>
                           <td class="">
                              <input type="text" id="amount_tr_1" class="amount w-100 form-control" name="amount[]" placeholder="Amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="text-align:right;" data-id="1"/>
                           </td>
                        ...
                        <table id="sundry_up_table" class="table-striped table m-0 shadow-sm table-bordered">
                           ...
                           <tbody class="testWrapper">
                              <tr id="billtr_1" class="font-14 font-heading bg-white bill_taxes_row sundry_tr">
                                    ...
                                    <select id="bill_sundry_1" class="w-95-parsent bill_sundry_tax_type form-select" name="bill_sundry[]" data-id="1">
                                       ...
                                       foreach ($billsundry as $value) { 
                                          if($value->effect_gst_calculation==1){?>
                                             <option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" data-sequence="<?php echo $value->sequence;?>" class="sundry_option_1" id="sundry_option_<?php echo $value->id;?>_1"><?php echo $value->name; ?></option>
                                             <?php 
                                          }
                                       } ?>
                                    </select>
                                 ...
                                 <td class="w-min-50">
                                    <input class="bill_amt w-100 form-control" type="text" name="bill_sundry_amount[]" id="bill_sundry_amount_1" data-id="1" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly style="text-align:right;">
                                 </td>
                                 <td></td>
                              </tr>
                              <div class="plus-icon">
                              ...
                              <tr id="billtr_cgst" class="font-14 font-heading bg-white bill_taxes_row sundry_tr" style="display:none">
                                 <td class="w-min-50">
                                    <select id="bill_sundry_cgst" class="w-95-parsent bill_sundry_tax_type form-select" name="bill_sundry[]" data-id="cgst">
                                       ...
                                       foreach ($billsundry as $value) { 
                                          if($value->id==1){?>
                                          <option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" data-sequence="<?php echo $value->sequence;?>" class="sundry_option_cgst" id="sundry_option_cgst"><?php echo $value->name; ?></option>
                                             <?php 
                                          }
                                       } ?>
                                    </select>
                                 ...
                                 <td class="w-min-50">
                                    <select id="bill_sundry_sgst" class="w-95-parsent bill_sundry_tax_type  form-select" name="bill_sundry[]" data-id="sgst">
                                       ...
                                       foreach ($billsundry as $value) { 
                                          if($value->id==2){
                                          ?>
                                          <option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" data-sequence="<?php echo $value->sequence;?>" class="sundry_option_sgst" id="sundry_option_sgst"><?php echo $value->name; ?></option>
                                          <?php 
                                          }
                                       } ?>
                                    </select>
                              ...
                              <tr id="billtr_igst" class="font-14 font-heading bg-white bill_taxes_row sundry_tr" style="display:none">
                                 <td class="w-min-50">
                                    <select id="bill_sundry_igst" class="w-95-parsent bill_sundry_tax_type  form-select" name="bill_sundry[]" data-id="igst">
                                       ...
                                       foreach ($billsundry as $value) { 
                                          if($value->id==3){?>
                                             <option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" data-sequence="<?php echo $value->sequence;?>" class="sundry_option_igst" id="sundry_option_igst"><?php echo $value->name; ?></option>
                                             <?php 
                                          }
                                       } ?>
                                    </select>
                              ...
                              <tr id="billtr_round_plus" class="font-14 font-heading bg-white bill_taxes_row sundry_tr" style="display:none">
                                 <td class="w-min-50">
                                    <select id="bill_sundry_round_plus" class="w-95-parsent bill_sundry_tax_type  form-select" name="bill_sundry[]" data-id="round_plus">
                                       ...
                                       foreach ($billsundry as $value) { 
                                          if($value->id==8){?>
                                             <option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" data-sequence="<?php echo $value->sequence;?>" class="sundry_option_round_plus" id="sundry_option_round_plus"><?php echo $value->name; ?></option>
                                             <?php 
                                          }
                                       } ?>
                                    </select>
                                 ...
                                 <td class="w-min-50"><input class="bill_amt w-100 form-control" type="text" name="bill_sundry_amount[]" id="bill_sundry_amount_round_plus" data-id="round_plus" readonly style="text-align:right;"></td>
                                 <td></td>
                              </tr>
                              <tr id="billtr_round_minus" class="font-14 font-heading bg-white bill_taxes_row sundry_tr" style="display:none">
                                 <td class="w-min-50">
                                    <select id="bill_sundry_round_minus" class="w-95-parsent bill_sundry_tax_type  form-select" name="bill_sundry[]" data-id="round_minus">
                                       ...
                                       foreach ($billsundry as $value) { 
                                          if($value->id==9){?>
                                             <option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" data-sequence="<?php echo $value->sequence;?>" class="sundry_option_round_minus" id="sundry_option_round_minus"><?php echo $value->name; ?></option>
                                             <?php 
                                          }
                                       } ?>
                                    </select>
                                 ...
                                 <td class="w-min-50"><input class="bill_amt w-100 form-control" type="text" name="bill_sundry_amount[]" id="bill_sundry_amount_round_minus" data-id="round_minus" readonly style="text-align:right;"></td>
                                 <td></td>
                              </tr>
                              <tr class="font-14 font-heading bg-white">
                                 <td class="w-min-50 fw-bold">Total</td>
...
<script>
   ...
   $(".add_more").click(function(){
      ...
      newRow += '</td><td class="w-min-50"><input type="text" class="quantity w-100 form-control" name="qty[]" id="quantity_tr_' + add_more_count + '" placeholder="Quantity" style="text-align:right" data-id="'+add_more_count+'"/></td><td class="w-min-50"><input type="text" class="w-100 form-control" id="unit_tr_'+add_more_count+'" readonly style="text-align:center;" data-id="'+add_more_count+'"/><input type="hidden" class="units w-100" name="units[]" id="units_tr_' + add_more_count + '"/></td><td class="w-min-50"><input type="text" class="price w-100 form-control" name="price[]" id="price_tr_' + add_more_count + '" placeholder="Price" style="text-align:right" data-id="'+add_more_count+'"/></td><td class="w-min-50"><input type="text" class="amount w-100 form-control" name="amount[]" id="amount_tr_' + add_more_count + '" placeholder="Amount" style="text-align:right" data-id="'+add_more_count+'"/></td><td class="w-min-50"><svg style="color: red;cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-minus-fill remove" data-id="' + add_more_count + '" viewBox="0 0 16 16"><path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M6 7.5h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1 0-1"/></svg></td></tr>';
      ...
      window.calculateAmount = function(key=null) {         
         ...
         $(".bill_sundry_tax_type").each(function(){            
            ...
            if($("#bill_sundry_amount_"+id).val()!='' && ($('option:selected', this).attr('data-sundry_percent')==undefined || $('option:selected', this).attr('data-sundry_percent')=="")){
               billSundryArray.push({'id':$(this).val(),'value':$("#bill_sundry_amount_"+id).val(),'type':$('option:selected', this).attr('data-type'),'adjust_sale_amt':$('option:selected', this).attr('data-adjust_sale_amt'),'sequence':$('option:selected', this).attr('data-sequence')});
            ...
            if(result.length>0){
               ...
               result.forEach(function(e){     
                  ...
                  if(e.percent==maxPercent){
                     if(billSundryArray.length>0){
                        billSundryArray.forEach(function(e){
                           if(e.id!=1 && e.id!=2 && e.id!=3 && e.id!=8 && e.id!=9){ 
                              if(e.value>0){
                  ...
                  if(index==1){
                     ...
                     $("#bill_sundry_"+add_more_bill_sundry_up_count).val(1)
                     ...
                     $("#bill_sundry_"+add_more_bill_sundry_up_count).val(2)
                     //$("#bill_sundry_amount_"+add_more_bill_sundry_up_count).prop('readonly',true);
                     $("#tax_amt_"+add_more_bill_sundry_up_count).html(e.percent/2+" %");
                     $("#tax_rate_tr_"+add_more_bill_sundry_up_count).val(e.percent/2);
                     if(taxSundryArray['sgst']=="" || taxSundryArray['sgst']==undefined){                        
            ...
            if(result.length>0){   
               ...
               result.forEach(function(e){     
                  ...
                  if(e.percent==maxPercent){
                     if(billSundryArray.length>0){
                        billSundryArray.forEach(function(e){
                           if(e.id!=1 && e.id!=2 && e.id!=3 && e.id!=3 && e.id!=8 && e.id!=9){ 
                              if(e.value>0){
                                 if(e.type=='additive' && e.adjust_sale_amt=='Yes'){
                                    item_taxable_amount = item_taxable_amount + parseFloat(e.value);
                                    final_total = final_total + parseFloat(e.value);
                  ...
                  if(index==1){
                     ...
                     //$("#bill_sundry_amount_"+add_more_bill_sundry_up_count).prop('readonly',true);
                     $("#bill_sundry_"+add_more_bill_sundry_up_count).val(3)
         ...
         $(".bill_sundry_tax_type").each(function(){
            ...
            if($('option:selected', this).attr('data-adjust_sale_amt')=="No" && $("#bill_sundry_amount_"+id).val()!='' && $(this).val()!=8 && $(this).val()!=9){
   ...
   $(".add_more_bill_sundry_up").click(function() {
      ...
      foreach ($billsundry as $value){ 
         if($value->effect_gst_calculation==1){?>
            optionElements += '<option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" class="sundry_option_'+add_more_bill_sundry_up_count+'" id="sundry_option_<?php echo $value->id;?>_'+add_more_bill_sundry_up_count+'" data-sequence="<?php echo $value->sequence;?>"><?php echo $value->name; ?></option>';<?php 
         }
      } ?>
   ...
   $(".add_more_bill_sundry_gst").click(function() {
      ...
      foreach ($billsundry as $value) { 
         if($value->id==1 || $value->id==2 || $value->id==3){?>
            optionElements += '<option value="<?php echo $value->id;?>" data-type="<?php echo $value->bill_sundry_type;?>" data-adjust_sale_amt="<?php echo $value->adjust_sale_amt;?>" class="sundry_option_'+add_more_bill_sundry_up_count+'" id="sundry_option_<?php echo $value->id;?>_'+add_more_bill_sundry_up_count+'" data-sequence="<?php echo $value->sequence;?>"><?php echo $value->name; ?></option>';
            <?php 
         }
      } ?>
