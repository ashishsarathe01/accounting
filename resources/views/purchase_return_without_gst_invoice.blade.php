            ...
            <div class="col-md-12 ml-sm-auto  col-lg-9 px-md-4 bg-mint">
                <div class="d-md-flex justify-content-between py-4 px-2 align-items-center">
                    <div class="d-md-flex d-block ">
                        <div class="calender-administrator my-2 my-md-0  w-min-230 noprint">
                            ...
                            <a href="{{ route('purchase-return-without-gst-invoice-pdf', $sale_return->id) }}"
                                 target="_blank"
                     ...
                     if ( in_array(date('Y-m', strtotime($sale_return->date)), $month_arr) && $sale_return->e_invoice_status == 0 && $sale_return->e_waybill_status == 0) {?>
                        <a href="{{ URL::to('purchase-return-edit/'.$sale_return->id) }}" class="btn btn-primary text-white">
                ...
                <table>
                    <tbody>
                        ...
                        <td colspan="4" style="width:50%;">
                           <p><span class="width25">Dr. Note No </span>: <span class="lft_mar15">{{$sale_return->sr_prefix}}</span> </p>
                           <p><span class="width25">Dr. Note Date </span>: <span class="lft_mar15">{{date('d-m-Y',strtotime($sale_return->date))}}</span> </p>
                           <p>&nbsp;</p>
                           <p>&nbsp;</p>
                           <p>&nbsp;</p>
                           <p>&nbsp;</p>
                     ...
                     <tr>
                        ...
                        <th colspan="3" style="text-align:left;">Account</th>
                     ...
                     @foreach($items as $item)
                        <tr>
                           ...
                           <td colspan="3"style="text-align:right;">{{formatIndianNumber($item->credit)}}</td>
                        </tr>
                        @php $i++;$item_total = $item_total + $item->credit;$percentage = $percentage + $item->percentage; @endphp
                     @endforeach 
                    <tr style="height: 23px;"><td colspan="1"></td><td colspan="4"></td><td colspan="3" ></td></tr>
                     ...
                     <tr>
                          <td colspan="8" style="border-top: 1px solid #dadada;"><strong>Narration : </strong>{{$sale_return->remark}}</td> 
                  </tr>
                     <tr>
