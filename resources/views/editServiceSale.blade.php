   ...
   <section class="list-of-view-company-section container-fluid">
      <div class="row vh-100">
         ...
         <div class="col-md-12 ml-sm-auto  col-lg-10 px-md-4 bg-mint">
            ...
            <h5 class="table-title-bottom-line px-4 py-3 m-0 bg-plum-viloet position-relative title-border-redius border-divider shadow-sm">Edit Service Sales Voucher</h5>
            <form class="bg-white px-4 py-3 border-divider rounded-bottom-8 shadow-sm" method="POST" action="{{ route('service-sale.update') }}" id="saleForm">
               @csrf
               <div class="row">
                  ...
                  <input type="hidden" id="gst_applicable" value="{{ $gstApplicable }}">
    ...
    <!-- @endif -->
                              ...
                              ?>
<tr id="billtr_cgst"
    class="font-14 font-heading bg-white bill_taxes_row sundry_tr"
    @if($gstApplicable == 0)
        style="display:none !important"
    @elseif(!isset($return['CGST']))
        style="display:none"
    @endif>
                                 <td class="w-min-50">
...
else
{
   ...
   total_item_taxable_amount = total + bill_sundry_total;
}
