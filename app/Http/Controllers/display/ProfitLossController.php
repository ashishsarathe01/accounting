   ...
   */
   ...
   public function filter(Request $request){
      ...
      return  view('display/profitLoss')->with('data', [
            'tot_purchase_amt'               => $plData['purchase'],
            'tot_sale_amt'                   => $plData['sale'],
            'financial_year'                 => $financial_year,
            'direct_expenses'                => $plData['direct_expenses'],
            'direct_income'                  => $plData['direct_income'],
            'opening_stock'                  => $plData['opening_stock'],
            'stock_in_transit_opening_value' => $plData['stock_in_transit_opening'],
            'total_opening_stock'            => $plData['total_opening_stock'],
            'total_closing_stock'            => $plData['total_closing_stock'],
            'closing_stock'                  => $plData['closing_stock'],
            'stock_in_transit_value'         => $plData['stock_in_transit'],
            'indirect_expenses'              => $plData['indirect_expenses'],
            'indirect_income'                => $plData['indirect_income'],
            'series'                         => $req_series,
            'gross_profit'   => $plData['gross_profit'],
            'gross_loss'     => $plData['gross_loss'],
            'trading_total'  => $plData['trading_total'],
            'net_profit'     => $plData['net_profit'],
            'net_loss'       => $plData['net_loss'],
            'pnl_total'      => $plData['pnl_total'],
         ])
         ->with('from_date',$from_date)
         ->with('to_date',$to_date)
         ->with('opening_stock',$plData['opening_stock'])
         ->with('indirect_expenses_credit',$plData['indirect_expenses_credit'])
         ->with('direct_expenses_credit',$plData['direct_expenses_credit'])
         ->with('debit_indirect_income',$plData['debit_indirect_income'])
         ->with('debit_direct_income',$plData['debit_direct_income'])
