                     ...
                     <div class="bg-white px-4 py-4 border-divider border-radius-8 shadow-sm multipal-show" @if($ind%2==0) style="background-color:#E8E8E8 !important" @endif>
                        ...
                        <div class="row e-waybill-yes">
                           ...
                           <div class="mb-4 col-md-4">
                              ...
                              <input type="password" class="form-control"  id="ewaybill_password_{{$index}}" name="ewaybill_password[{{$index}}][]" placeholder="Enter password"  value="@if(!empty($value->ewaybill_password)){{decrypt($value->ewaybill_password)}}@endif">
                           </div>
                        </div>
                        <!-- addbranch toggle -->
